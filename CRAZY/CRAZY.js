(function(win, doc) {
  var adData = {
    owidth: 25, // Ad width - original
    oheight: 150, // Ad height - original
    ewidth: 1000, // Ad width - expanded
    eheight: 400, // Ad height - expanded
    swfObj: 'http://buzzads.b0.upaiyun.com/ads/20150624/201506241744558406.swf', //http://buzzads.b0.upaiyun.com/ads/20150611/201506111500445618.swf', // Flash link
    landingPage: 'http://c02.optimix.asia/imageviews?opxCREATIVEID=9285&opxPLACEMENTID=3026&opxInterest=&opxGender=&opxAge=25-34&opxCREATIVEASSETID=43290&opxMODE=1&opxURL=http://c.admaster.com.cn/c/a51120,b618784,c571,i0,m101,h', // Click Url
    dropImg: '', // Thumbnail image link
    closeImg: 'http://static.buzzads.com/repository/ads/20150623/201506231824408219.jpg',
    status: 'PLAYING', // Auto play or not
    tagId: "bzp-" + (new Date()).getTime(),
    type:"CRAZY"
  };
  var bzp = win.buzzPlayer = {
    ...
    creatFlash:function(options) {
          ...
          if(options.type==="CRAZY"){
            htm+='<span id="bzpClose" onclick="buzzPlayer.close()" style="width:25px;height:25px;cursor:pointer;text-align:center;' +
